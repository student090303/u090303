...
class KPIDepartmentTable extends Entity\DataManager {
	...
	public static function getMap()
	{
		return array(
			...
			'UF_DEPARTMENT' => array(
				'data_type' => 'integer',
				'required' => true,
				'title' => Loc::getMessage('KPI_ENTITY_UF_DEPARTMENT_FIELD')
			),
			'UF_CREATED_BY' => array(
				'data_type' => 'integer',
				'required' => true,
				'title' => Loc::getMessage('KPI_ENTITY_UF_CREATED_BY_FIELD')
			),
			'UF_CREATED' => array(
				'data_type' => 'datetime',
				'required' => true,
			...
			'UF_CHANGED_BY' => array(
				'data_type' => 'integer',
				'title' => Loc::getMessage('KPI_ENTITY_UF_CHANGED_BY_FIELD')
			),
			'UF_CHANGED' => array(
				'data_type' => 'datetime',
			...
			'UF_PERIOD' => array(
				'data_type' => 'date',
				'title' => Loc::getMessage('KPI_ENTITY_UF_PERIOD_FIELD'),
			),
	...
	{
		return array(
			new Entity\Validator\Range(0, null, false, array("MIN" => Loc::getMessage('KPI_DEPARTMENT_V_ZERO'))),
		);
	}
}